import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as p,c as u,a as s,b as n,e as a,w as l,f as e}from"./app-ad0845b4.js";const d={},r=e(`<p>一般称为 <strong>中间件</strong> ，很重要，</p><p>前进后退，设置 权限控制在这里</p><h2 id="全局前置守卫" tabindex="-1"><a class="header-anchor" href="#全局前置守卫" aria-hidden="true">#</a> 全局前置守卫</h2><p><code>router.beforeEach</code></p><div class="language-vbscript line-numbers-mode" data-ext="vbscript"><pre class="language-vbscript"><code>router.beforeEach((to, form, next) =&gt; {
    console.log(to, form);
    next()
})
...
router<span class="token punctuation">.</span><span class="token function">afterEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span>to<span class="token punctuation">,</span> from<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
    Vnode<span class="token punctuation">.</span>component<span class="token operator">?.</span>exposed<span class="token operator">?.</span><span class="token function">endLoading</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),k=s("br",null,null,-1),b={href:"https://blog.csdn.net/qq1195566313/article/details/123699583",target:"_blank",rel:"noopener noreferrer"};function g(f,h){const t=i("RouterLink"),o=i("ExternalLinkIcon");return p(),u("div",null,[r,s("p",null,[n("完整案例："),a(t,{to:"/code/vue/vue3-router4/08.a-%E5%85%A8%E5%B1%80%E5%89%8D%E7%BD%AE%E5%AE%88%E5%8D%AB%E6%A1%88%E4%BE%8B-%E7%99%BB%E9%99%86%E5%88%A4%E6%96%AD%E8%B7%AF%E7%94%B1.html"},{default:l(()=>[n("08.a-全局前置守卫案例-登陆判断路由")]),_:1})]),v,s("p",null,[n("使用场景一般可以用来做 "),a(t,{to:"/code/vue/vue3-router4/08.b-%E5%85%A8%E5%B1%80%E5%90%8E%E7%BD%AE%E5%AE%88%E5%8D%AB%E6%A1%88%E4%BE%8B-%E8%BF%9B%E5%BA%A6%E6%9D%A1%E5%8A%A0%E8%BD%BD.html"},{default:l(()=>[n("loadingBar 完整案例")]),_:1})]),m,s("blockquote",null,[s("p",null,[n("版权声明：本文为博主原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接和本声明。"),k,n(" 本文链接："),s("a",b,[n("https://blog.csdn.net/qq1195566313/article/details/123699583"),a(o)])])])])}const _=c(d,[["render",g],["__file","08-导航守卫.html.vue"]]);export{_ as default};
