import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as t}from"./app-ad0845b4.js";const e={},p=t(`<h1 id="_01b-使用-redux-保存状态信息" tabindex="-1"><a class="header-anchor" href="#_01b-使用-redux-保存状态信息" aria-hidden="true">#</a> 01b-使用 redux 保存状态信息</h1><h2 id="reduxjs-toolkit-工具" tabindex="-1"><a class="header-anchor" href="#reduxjs-toolkit-工具" aria-hidden="true">#</a> reduxjs/toolkit 工具</h2><div class="language-jsx line-numbers-mode" data-ext="jsx"><pre class="language-jsx"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>createSlice<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;@reduxjs/toolkit&quot;</span><span class="token punctuation">;</span>
