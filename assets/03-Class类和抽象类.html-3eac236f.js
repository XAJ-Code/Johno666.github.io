...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-ts-定义类" tabindex="-1"><a class="header-anchor" href="#_1-ts-定义类" aria-hidden="true">#</a> 1. TS 定义类</h2><p>在 TypeScript 是不允许直接在 constructor 定义变量的 需要在 constructor 上面先声明<br><img src="`+r+'" alt="Pasted image 20221230165352" loading="lazy"></p><p>这样引发了第二个问题你如果了定义了变量不用 也会报错 通常是给个默认值 或者 进行赋值</p><h2 id="_2-类的修饰符" tabindex="-1"><a class="header-anchor" href="#_2-类的修饰符" aria-hidden="true">#</a> 2. 类的修饰符</h2><h3 id="总共有三个-public-private-protected" tabindex="-1"><a class="header-anchor" href="#总共有三个-public-private-protected" aria-hidden="true">#</a> 总共有三个 public private protected</h3><p>公开，私有，保护</p><h3 id="static-静态属性" tabindex="-1"><a class="header-anchor" href="#static-静态属性" aria-hidden="true">#</a> static 静态属性</h3><p>静态方法只能调用静态属性</p><h2 id="抽象类" tabindex="-1"><a class="header-anchor" href="#抽象类" aria-hidden="true">#</a> 抽象类</h2><p>跟 java 一模一样</p>',13),c=[t];function d(l,o){return a(),i("div",null,c)}const u=e(n,[["render",d],["__file","03-Class类和抽象类.html.vue"]]);export{u as default};
