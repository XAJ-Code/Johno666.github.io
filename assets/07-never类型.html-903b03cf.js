import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-ee3e8713.js";const p="/assets/Pasted-image-20221230183054-6618109f.png",t={},o=e(`<p>TypeScript 将使用 never 类型来表示不应该存在的状态(很抽象是不是)</p><blockquote><p><mark>统一规范：后来者，必须按前辈的逻辑套路强制做事，否则报错</mark><br> 由于任何类型都不能赋值给 <code>never</code> 类型的变量，所以 <code>switch</code> 当存在进入 <code>default</code> 分支的可能性时，TS 的类型检查会及时帮我们发现这个问题</p></blockquote><h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">bbb</span> <span class="token operator">=</span> <span class="token builtin">string</span> <span class="token operator">&amp;</span> <span class="token builtin">number</span>
