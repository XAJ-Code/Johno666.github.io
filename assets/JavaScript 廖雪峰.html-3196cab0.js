import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as l,c as r,a as i,b as e,e as c,f as n}from"./app-ad0845b4.js";const v={},o=n(`<h1 id="javascript-廖雪峰" tabindex="-1"><a class="header-anchor" href="#javascript-廖雪峰" aria-hidden="true">#</a> JavaScript 廖雪峰</h1><p>目录</p><p>JavaScript简介</p><p>快速入门</p><h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数" aria-hidden="true">#</a> 函数</h2><p>函数定义和调用</p><p>利用 <code>arguments</code>，你可以获得调用者传入的所有参数。也就是说，即使函数不定义任何参数，还是可以拿到参数的值：</p><div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre class="language-JavaScript"><code>function abs() {
